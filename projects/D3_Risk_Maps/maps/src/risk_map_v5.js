function showDataMap() {
  ...
  function createMapOii() {
    ...
    window.addEventListener('octaeMapResize2', function () { octaeMap.octaeMapResize2(); });
  }
  ...
  function createMapOctae() {
    ...
    mapOctae.labels();
    window.addEventListener('resizeMapOctae', function () { map.resizeMapOctae(); });
  }
